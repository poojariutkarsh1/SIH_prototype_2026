...
// =====================================================
// FOG / VISIBILITY SETTINGS
// =====================================================

// Hardcoded test values
// Change these to simulate different fog conditions
// NOTE: With these defaults (25C / 90% RH), dew point depression
// is ~1.75C, which falls in the HIGH fog bucket below.

float TEST_TEMPERATURE = 25.0;
float TEST_HUMIDITY    = 90.0;
...
// BASE SPEEDS
// =====================================================
// Only 3 fog tiers now: LOW, MODERATE, HIGH

const int CLEAR_SPEED      = 80;   // LOW fog
const int MODERATE_SPEED   = 60;   // MODERATE fog
const int HIGH_FOG_SPEED   = 40;   // HIGH fog
...
// =====================================================
// GET DEW POINT DEPRESSION (shared helper)
// =====================================================

float getDewPointDepression() {

  float T = TEST_TEMPERATURE;
  float RH = TEST_HUMIDITY;
...
// =====================================================
// GET FOG RISK
// Only 3 tiers: HIGH, MODERATE, LOW
// =====================================================

String getFogRisk() {

  float dewPointDepression = getDewPointDepression();
...
int getBaseSpeed() {
  ...
  // Convert fog risk into speed

  if (dewPointDepression <= 2.0) {

    return HIGH_FOG_SPEED;
  }
